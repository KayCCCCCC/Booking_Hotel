...
import HotelTypesFilter from "../components/filters/HotelTypeFilter";
...
const Search = () => {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-5">
            <div className="rounded-lg border border-x-slate-300 p-5 h-fit sticky top-10">
            ...
            <div className="flex flex-col gap-5">
                ...
                {
                    hotelsData?.data.map((hotel, index) => (
                        <SearchResultCard key={index} hotel={hotel} />
                    ))
                }
                <div>
                    <Pagination page={hotelsData?.pagination.page || 1} totalPage={hotelsData?.pagination.totalPage || 1} onPageChange={(page) => setPage(page)} />
                </div>
            </div>
        </div>
    )
